#!/usr/bin/env python3
"""Write the complete ai-fatigue.html by appending to existing file."""

import os

path = "/Users/nightcoder/Desktop/TheClearing/ai-fatigue.html"

# The remaining content to append
tail = """
<p>AI tools make it trivially easy to produce code at a rate that no human could sustainably match. This creates a comparison trap: because AI can generate code so quickly, you begin to measure yourself against AI's output rather than against human standards. You feel behind because you cannot match AI's velocity, even though AI's velocity is not a meaningful benchmark for human engineers.</p>
  <p>The trap deepens because AI tools are always improving. The moment you feel caught up, a new model releases and the bar moves again. The goalposts are on a treadmill, and you are running on it. This creates a form of learned helplessness: the feeling that no matter how hard you work, you will never be caught up, never be good enough, never be fast enough. The anxiety this produces is constant and insidious — and it is a feature of the tools, not a bug in you.</p>
</div>
...
<div class="severity-band">
  ...
  <p>This is the earliest stage, and it is also the most treatable. The interventions at this stage are simple: occasional no-AI time blocks, deliberate practice sessions, and regular reflection on how your skills are developing (or not).</p>
  <ul class="actions">
...
<div class="recovery-grid">
  <div class="recovery-card">
    ...
    <p>Practical steps: schedule AI tool use in defined windows (batch it), build a 5-minute transition ritual between AI sessions and independent work (walk, stretch, close eyes), protect at least one 90-minute block per day from AI tool use entirely.</p>
  </div>
  <div class="recovery-card">
  ...
  <div class="recovery-card">
    ...
    <p>Practical steps: keep a craft journal (record the problems you solved, the solutions you built, the things you learned — even if AI helped), set a personal rule that at least one component of every project must be built without AI, define and defend your own standards for what "good enough" means.</p>
  </div>
  <div class="recovery-card">
...
<div class="faq-item" onclick="this.classList.toggle('open')">
  ...
  <div class="faq-a">AI fatigue is a distinct condition affecting software engineers who use AI coding tools (GitHub Copilot, Cursor, ChatGPT, Claude Code). It is characterized by four overlapping dimensions: cognitive overload from managing AI suggestions, skill atrophy from reduced active problem-solving, identity disruption from lost authorship and craft erosion, and emotional exhaustion from the constant pressure to keep up. It typically manifests as feeling productive without feeling competent — shipping more code while trusting it less.</div>
</div>

<div class="faq-item" onclick="this.classList.toggle('open')">
  <div class="faq-q">What are the symptoms of AI fatigue?</div>
  <div class="faq-a">AI fatigue symptoms include: shipping code you do not fully understand, dreading the Sunday planning session, feeling guilty when not using AI tools, diminished craft satisfaction, compulsive tool-switching between AI products, loss of problem-solving confidence, feeling perpetually behind, decreased attention span for non-AI tasks, and noticing your debugging skills eroding. These cluster into cognitive (brain-fog, reduced retention), emotional (guilt, anxiety, identity loss), behavioral (tool-switching, avoidance), and social dimensions (withdrawing from code reviews, hiding AI use).</div>
</div>
